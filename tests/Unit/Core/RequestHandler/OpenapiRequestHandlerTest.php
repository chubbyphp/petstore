...
namespace App\Tests\Unit\Core\RequestHandler;
...
/**
 * @covers \App\Core\RequestHandler\OpenapiRequestHandler
 *
 * @internal
 */
        ...
        $streamFactory = $builder->create(StreamFactoryInterface::class, [
            new WithCallback(
                ...
                static function (string $filename, string $mode) use ($responseStream): StreamInterface {
                    self::assertMatchesRegularExpression('#src/Core/RequestHandler/../../../openapi\.yml$#', $filename);
